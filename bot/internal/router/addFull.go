...
func (r *BirthdayRouter) addFull(message tgbotapi.Message) {
	regex := regexp.MustCompile("^(?:0[1-9]|[12][0-9]|3[01])-(?:0[1-9]|1[012])-[0-9]{4}$")
	...
	date := fmt.Sprintf("%s-%s-%sT01:01:01:001Z", splittedMessage[2], splittedMessage[0], splittedMessage[1])
