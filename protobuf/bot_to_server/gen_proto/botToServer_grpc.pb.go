...
func (c *congratulationServiceClient) GetStatistics(ctx context.Context, in *ChatRequest, opts ...grpc.CallOption) (*PDFResponse, error) {
	out := new(PDFResponse)
	err := c.cc.Invoke(ctx, CongratulationService_GetStatistics_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CongratulationService_GetStatistics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChatRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CongratulationServiceServer).GetStatistics(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CongratulationService_GetStatistics_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CongratulationServiceServer).GetStatistics(ctx, req.(*ChatRequest))
	}
	return interceptor(ctx, in, info, handler)
}
